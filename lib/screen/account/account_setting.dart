...
class AccountSetting extends StatelessWidget {
  List<AccountSettingModel> list = AccountSettingModel.getAccountListOptions();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const AppBarWidget(title: "Account Settings"),
      body: ListView.separated(
          padding: const EdgeInsets.symmetric(vertical: 20, horizontal: 15),
          itemBuilder: (_, index) {
            final item = list[index];
            return OptionButton(title: item.title, onTap: (){
